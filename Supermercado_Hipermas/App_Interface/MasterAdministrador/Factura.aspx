<%@ Page Title="" Language="C#" MasterPageFile="~/Principal3.master" AutoEventWireup="true" CodeFile="Factura.aspx.cs" Inherits="App_Interface_MasterAdministrador_Factura" %>
    ...
    <table class="auto-style22">
        ...
        <tr>
            ...
            <td class="auto-style34">
                <asp:Label ID="Label4" runat="server" CssClass="auto-style33" Text="ID Administrador:"></asp:Label>
